...
df_results = pd.DataFrame(columns=["case_id", "sensitivity", "specificity", "ROC_AUC", "optimal_threshold", "annotation_overlay_iph_path", "annot$
...
for heatmap_path in glob.glob(heatmap_dir + "*_test.png"):
    ...
    df_results = df_results.append({
        "case_id": case_id,
        "sensitivity": enhanced_metric["sensitivity"],
        "specificity": enhanced_metric["specificity"],
        "ROC_AUC": enhanced_metric["ROC_AUC"],
        "optimal_threshold": enhanced_metric["optimal_threshold"],
