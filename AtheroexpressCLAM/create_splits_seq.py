...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal', 'task_2_tumor_subtyping', 'wsi_classification', 'wsi_classification_binary'])
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes=6
    dataset = Generic_WSI_Classification_Dataset(csv_path ='dataset_csv/AtheroExpress_WSI_dataset.csv',
                                                 shuffle = False,
                                                 seed = args.seed,
                                                 print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path ='dataset_csv/AtheroExpress_WSI_dataset_binary.csv',
                                                 shuffle = False,
                                                 seed = args.seed,
                                                 print_info = True,
